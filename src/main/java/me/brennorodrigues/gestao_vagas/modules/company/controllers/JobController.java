...
import me.brennorodrigues.gestao_vagas.modules.company.dto.CreateJobDTO;
...
public class JobController {
    ...
    @PostMapping("")
    public @Valid JobEntity create(@Valid @RequestBody CreateJobDTO createJobDTO, HttpServletRequest request) {
